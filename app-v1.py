...
st.set_page_config(page_title="Dashboard GSC - Analisis Keyword Terbaik", layout="wide")

st.title("📈 Dashboard Google Search Console - Analisis Keyword Terbaik Berdasarkan Kode Negara")
...
with st.sidebar:
    ...
    # Tema Tampilan
    theme = st.radio("Pilih Tema Tampilan:", ["Terang", "Gelap"])
    if theme == "Gelap":
